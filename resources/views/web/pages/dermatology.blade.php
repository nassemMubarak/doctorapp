...
<div class="container d-lg-flex justify-content-center d-sm-block style">
    ...
    <div class="care-section">
        <img class="d-lg-block d-sm-none" src="{{ asset('assets/web/assets/images/Dermalong.png') }}"/>
        <p class="sup-head">Dermalogy</p>
        <div class="row ">
        ...
        <p class="content-paragraph">NEOGEN DERMALOGY Real Ferment Micro Collection - with Naturally Fermented ingredients
            (Rice) & Hyaluronic Acid for Hydrated, Brightened and Healthy skin.
        </p>
    </div>
</div>
