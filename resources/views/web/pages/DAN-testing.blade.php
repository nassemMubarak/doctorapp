...
<div class="container d-lg-flex justify-content-center d-sm-block style">
    ...
    <div class="care-section">
        <img class="d-lg-block d-sm-none" src="{{ asset('assets/web/assets/images/dan-testing.png') }}"/>
        <p class="sup-head">DNA Testing</p>
        <div class="row " >
        ...
        <p class="content-paragraph">Gene analysis or genetic examination (DNA Anaysis or DNA Test) is a molecular biology
            analysis method for DNA analysis, for the purpose of identifying people's genetic composition. Genetic
            examination methods are also used in genetic studies and the development of animal and plant kingdoms. Research
            is also being conducted to analyze the evolution of the eye through genetic analysis of organisms.</p>
    </div>
</div>
