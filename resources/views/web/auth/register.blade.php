            ...
            <div class="col-lg-6 offset-lg-3 col-md-10 offset-md-1 col-12">
                <div class="register-form">
                      ...
                      <form class="row" action="{{ route('register') }}" method="post" enctype="multipart/form-data">
                          ...
                          <div class="col-sm-6">
                              <div class="form-group">
                                  ...
                                  <input class="form-control @error('national_id') is-invalid @enderror" type="text" name="national_id" value="{{ old('national_id') }}" required>
                                  @error('national_id')
                                  <div class="invalid-feedback">{{ $message }}</div>
                                  @enderror
                              </div>
                          ...
                          <div class="col-sm-6">
                              <div class="form-group">
                                  ...
                                  <input class="form-control @error('identity_image') is-invalid @enderror" type="file" name="identity_image" accept="image/*">
                  ...
                  <div id="form-doctor" style="display: none;">
                    ...
                    <form class="row" action="{{ route('admin.register') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <!-- Name -->
                        <div class="col-sm-6">
                            <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('specialty') is-invalid @enderror" type="text" name="specialty" value="{{ old('specialty') }}" required>
                                @error('specialty')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
