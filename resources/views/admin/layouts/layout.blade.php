...
{{--											<span class="symbol-label font-size-h5 font-weight-bold">U</span>--}}
					...
					<div class="content d-flex flex-column flex-column-fluid " id="kt_content">
						...
						<!--end::Subheader-->
						<!--begin::Entry-->
						<div class="d-flex flex-column-fluid" style="margin-top: -60px">
							<!--begin::Container-->
							<div class="container">
								@yield('content')
							</div>
					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a target="_blank" class="text-dark-75 text-hover-primary">{{ config('app.name') }}</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					...
					<div class="d-flex flex-column">
						...
						<div class="text-muted mt-1">{{ Auth::user()->description }}</div>
						<div class="navi mt-2">
							<a class="navi-item">
				...
				<div class="navi navi-spacer-x-0 p-0">
					<!--begin::Item-->
					<a href="{{ route('admin.profiles.index') }}" class="navi-item">
						<div class="navi-link">
...
{{--				</div>--}}
        ...
        <!--end::Page Scripts-->
        <script src="{{ asset('assets/admin/assets/js/pages/custom/profile/profile.js') }}"></script>
