                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.users.update', $user->id) }}" method="POST"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text"
                                                ...
                                                name="national_id" value="{{ old('national_id', $user->national_id) }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <textarea class="form-control @error('address') is-invalid @enderror" name="address" placeholder="Address...">{{ old('address', $user->address) }}</textarea>
                                            @error('address')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
